...
function Sidebar() {
    const {data} = useConnectionsQuery(null);
    return (
        <aside
            id="sidebar"
        ...
        >
            ...
            <div
                className="flex h-full flex-col overflow-y-auto border-r border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
